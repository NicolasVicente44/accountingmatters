...
const Services = () => {
  return (
    <div className="services-feature flex flex-wrap justify-center mr-20 ml-20 pt-5 pb-5">
      <a href="/" className="w-full md:w-1/2 lg:w-1/4 p-4 flex flex-col items-center mt-6">
        ...
        <h3 className="text-xl font-semibold mt-4 text-center">Services for Individuals</h3>
      ...
      <a href="/" className="w-full md:w-1/2 lg:w-1/4 p-4 flex flex-col items-center mt-6">
        ...
        <h3 className="text-xl font-semibold mt-4 text-center">Business Services</h3>
        <p className="mt-2 text-center">
      ...
      <a href="/" className="w-full md:w-1/2 lg:w-1/4 p-4 flex flex-col items-center mt-6">
        ...
        <h3 className="text-xl font-semibold mt-4 text-center">QuickBooks Services</h3>
        <p className="mt-2 text-center">
